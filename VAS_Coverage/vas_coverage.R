...
# Stefano Balbo for Reforma Consulting # 
# The code may not function as intended due to the absence of datasets that are withheld under private policies. #
...
# HH %% # 
congo_HR = read_dta("VAS_Coverage/data_files/Congo/CDHR61FL.DTA") # Household Data - Household Recode (HR)
...
# CH %% # 
congo_KR = read_dta("VAS_Coverage/data_files/Congo/CDKR61FL.DTA") # Children's Data - Children's Recode (KR)
...
# # # 
# Children Dataset Cleaning & Analysis #
...
proportions_hh = read.csv("VAS_Coverage/results/congo_hhproportions.csv")
proportions_ch = read.csv("VAS_Coverage/results/congo_chproportions.csv")
...
names(congo_child)
names(final_data)
congo_hh_GIS = st_read("VAS_Coverage/data_files/Congo/GPS/CDGE61FL_DHS_hous/CDGE61FL.shp") # Household-GPS points
congo_fa_GIS = st_read("VAS_Coverage/data_files/Congo/GPS/CDGE71FLSR_SPA_faci/CDGE71FLSR.shp") # Facility-GPS points
congo = openxlsx::read.xlsx("VAS_Coverage/results/congo_hh.xlsx")
...
setwd("C:\\Users\\stefa\\Documents\\Code\\VAS_Optimization/GIS layers/"); getwd()
...
path = 'C:\\Users\\stefa\\Documents\\Code\\VAS_Optimization/Vit A Inception/VAS Cost Optimization/'
...
# Replicated for Togo, Niger and Liberia #
...
# proportions
# 
# path = 'C:\\Users\\stefa\\Documents\\Code\\VAS_Optimization/Vit A Inception/results/'
...
# # path = 'C:\\Users\\stefa\\Documents\\Code\\VAS_Optimization/'
...
# 
# # Save results
# setwd("C:\\Users\\stefa\\Documents\\Code\\VAS_Optimization/Vit A Inception/results/"); getwd()
...
# 
# # Probit by regions
# summary(togo$vas_coverage) # children's VAS_Coverage in %
...
# 
# 
# setwd("C:\\Users\\stefa\\Documents\\Code\\VAS_Optimization/Vit A Inception/"); getwd()
...
#   labs(x = "VAS_Coverage (%)", 
#        y = "Number of Children (6-59 months)", 
#        title = "Togo Children VAS_Coverage Distribution",
#        caption = "Data source: DHS Survey Datasets") +
#   theme_minimal() +  # Use a minimal theme for a clean look
#   theme(plot.caption = element_text(hjust=0, face="italic"))  # Align and style the caption text
# print(hist_vas)
...
#   scale_size(range = c(3, 15), name = "Total Children Weight") +
#   labs(
#     title = "Togo Average VAS_Coverage by Cluster | Children 6-59 months old",
#     subtitle = "Vitamin A Supplementation Coverage",
#     caption = "Data source: GADM | DHS Survey Datasets"
#   ) +
#   theme_minimal() +
...
#   scale_size(range = c(3, 15), name = "Total Children Weight") +
#   labs(
#     title = "Togo Average VAS_Coverage by Cluster | Children 6-24 months old",
#     subtitle = "Vitamin A Supplementation Coverage",
#     caption = "Data source: GADM | DHS Survey Datasets"
#   ) +
#   theme_minimal() +
...
#   scale_size(range = c(3, 15), name = "Total Children Weight") +
#   labs(
#     title = "Togo Average VAS_Coverage by Cluster | Children 24-59 months old",
#     subtitle = "Vitamin A Supplementation Coverage",
#     caption = "Data source: GADM | DHS Survey Datasets"
#   ) +
#   theme_minimal() +
...
# 
# # Probit by regions
# summary(niger$vas_coverage) # children's VAS_Coverage in %
...
#   labs(x = "VAS_Coverage (%)", 
#        y = "Number of Children (6-59 months)", 
#        title = "Niger Children VAS_Coverage Distribution",
#        caption = "Data source: DHS Survey Datasets") +
#   theme_minimal() +  # Use a minimal theme for a clean look
#   theme(plot.caption = element_text(hjust=0, face="italic"))  # Align and style the caption text
# print(hist_vas)
...
#   scale_size(range = c(3, 15), name = "Total Children Weight") +
#   labs(
#     title = "Niger Average VAS_Coverage by Cluster | Children 6-59 months old",
#     subtitle = "Vitamin A Supplementation Coverage",
#     caption = "Data source: GADM | DHS Survey Datasets"
#   ) +
#   theme_minimal() +
...
#   scale_size(range = c(3, 15), name = "Total Children Weight") +
#   labs(
#     title = "Niger Average VAS_Coverage by Cluster | Children 6-24 months old",
#     subtitle = "Vitamin A Supplementation Coverage",
#     caption = "Data source: GADM | DHS Survey Datasets"
#   ) +
#   theme_minimal() +
...
#   scale_size(range = c(3, 15), name = "Total Children Weight") +
#   labs(
#     title = "Niger Average VAS_Coverage by Cluster | Children 24-59 months old",
#     subtitle = "Vitamin A Supplementation Coverage",
#     caption = "Data source: GADM | DHS Survey Datasets"
#   ) +
#   theme_minimal() +
...
# 
# # Probit by regions
# summary(liberia$vas_coverage) # children's VAS_Coverage in %
...
#   labs(x = "VAS_Coverage (%)", 
#        y = "Number of Children (6-59 months)", 
#        title = "liberia Children VAS_Coverage Distribution",
#        caption = "Data source: DHS Survey Datasets") +
#   theme_minimal() +  # Use a minimal theme for a clean look
#   theme(plot.caption = element_text(hjust=0, face="italic"))  # Align and style the caption text
# print(hist_vas)
...
#   scale_size(range = c(3, 15), name = "Total Children Weight") +
#   labs(
#     title = "Liberia Average VAS_Coverage by Cluster | Children 6-59 months old",
#     subtitle = "Vitamin A Supplementation Coverage",
#     caption = "Data source: GADM | DHS Survey Datasets"
#   ) +
#   theme_minimal() +
...
#   scale_size(range = c(3, 15), name = "Total Children Weight") +
#   labs(
#     title = "Liberia Average VAS_Coverage by Cluster | Children 6-24 months old",
#     subtitle = "Vitamin A Supplementation Coverage",
#     caption = "Data source: GADM | DHS Survey Datasets"
#   ) +
#   theme_minimal() +
...
#   scale_size(range = c(3, 15), name = "Total Children Weight") +
#   labs(
#     title = "Liberia Average VAS_Coverage by Cluster | Children 24-59 months old",
#     subtitle = "Vitamin A Supplementation Coverage",
#     caption = "Data source: GADM | DHS Survey Datasets"
#   ) +
#   theme_minimal() +
